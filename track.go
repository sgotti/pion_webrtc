...
// error. If a track is multistream it'll return a nil value (use TrackStream.Read())
...
// you. If a track is multistream it'll return a nil value (use TrackStream.ReadRTP())
